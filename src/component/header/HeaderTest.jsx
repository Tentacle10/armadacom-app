...
const HeaderTest = () => {
  ...
  return (
    <>
      <Navbar key='md' expand='md' data-bs-theme='dark' className='navigation-wrap start-header start-style' fixed='top' ref={ref}>
        <Container className='con-nav' fluid>
          <Navbar.Brand href='#'>
            <img src={ArmadaIcon} className='logo-blue d-inline-block align-top' alt='Logo_Armada' />
          </Navbar.Brand>
          <Navbar.Toggle aria-controls='offcanvasNavbar-expand-md' type='button' aria-label='Toggle navigation' className='' />
          <Navbar.Offcanvas id='offcanvasNavbar-expand-md' aria-labelledby='offcanvasNavbarLabel-expand-md' placement='end' data-bs-theme='dark'>
            ...
            <Offcanvas.Body className='px-5'>
              <Nav className='d-flex justify-content-end flex-grow-1 pe-3'>
                <Nav.Link ref={hover[0]} href='#home' className='nav-item px-2 mx-2'>
                  Home
                </Nav.Link>
                <Nav.Link ref={hover[1]} href='#about' className='nav-item px-2 mx-1'>
                  About Us
                </Nav.Link>
                <NavDropdown title='Layanan' id='offcanvasNavbarDropdown-expand-md' className='px-2 mx-1' ref={hover[2]} renderMenuOnMount={true}>
                ...
                <Nav.Link ref={hover[3]} href='#testimonials' className='nav-item px-2 mx-1'>
                  Testimonial
                </Nav.Link>
              </Nav>
              <Button className='btn-blue' variant='light'>
                Pricelist
              </Button>
            </Offcanvas.Body>
