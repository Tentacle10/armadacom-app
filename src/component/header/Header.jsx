            ...
            <Navbar.Offcanvas id="offcanvasNavbar-expand-md" aria-labelledby="offcanvasNavbarLabel-expand-md" placement="end" data-bs-theme="light">
              ...
              <Offcanvas.Body className="justify-content-md-end px-5">
                <Nav className="navbar-nav align-items-md-center py-3 py-md-0">
                  <Nav.Link href="#home" className="nav-item" active={activeSection === "home"}>
                    Home
                  </Nav.Link>
                  <Nav.Link href="#about" className="nav-item" active={activeSection === "about"}>
                    About Us
                  </Nav.Link>
                  <NavDropdown
                    className=""
                  ...
                  >
                    ...
                    <NavDropdown.Item href="#service" active={activeSection === "service"}>
                      Service
                    </NavDropdown.Item>
                    <NavDropdown.Item href="#damkar" className="border border-primary-subtle f-damkar" active={activeSection === "damkar"}>
                      Damkar Express
                    </NavDropdown.Item>
                    <NavDropdown.Item href="#software" active={activeSection === "software"}>
                      Software
                    </NavDropdown.Item>
                  </NavDropdown>
                  <Nav.Link href="#testimonials" className="nav-item" active={activeSection === "testimonials"}>
                    Testimonial
                  </Nav.Link>
