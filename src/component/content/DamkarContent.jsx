      ...
      <Container className="cdamkar">
        <Row className="damkar text-light">
          ...
          <Col sm={6} className="d-flex flex-column text-center justify-content-start justify-content-md-center align-items-center px-md-5 pt-md-4 pb-4">
            ...
            <div className="ts fw-bold fs-4 pb-md-3  d-none d-md-block">ANDA BELI KAMI ANTAR</div>
            <div className="ts dtext fw-lighter text-opacity-75">Damkar hadir sebagai solusi penuh kenyamanan untuk kebutuhan jualan, servis, dan antar jemput. Nikmati kemudahan servis dan beli tanpa perlu keluar rumah</div>

            <Button className="btn-a mt-4 px-3 py-2" variant="light" href="https://damkar.armadacom.id/">
              Lihat Harga
            </Button>
          </Col>
        </Row>
