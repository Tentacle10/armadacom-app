  ...
  const devcard = [
    {
      ...
      // list: "Aplikasi kasir berbasis website yang bisa kalian pakai dari mana aja dengan fitur lengkap dan interface yang memukau.",
    },
    {
      icon: UpSensei,
      title: "UP-SENSEI",
      ...
      // list: "Aplikasi Absensi menggunakan ID Card sebagai device absen, dengan laporan yang presisi dan mudah dipahami. Cepat,Mudah,Akurat.",
    },
    {
      icon: Evoting,
      title: "E-Voting",
      desc: "Software vote pemilihan pimpinan untuk organisasi maupun instansi, kemudahan dalam rekap dan tanpa media kertas.",
      // list: "Software vote pemilihan pimpinan untuk organisasi maupun instansi, kemudahan dalam rekap dan tanpa media kertas.",
    },
    {
      icon: Custom,
      title: "Custom Software",
      desc: "Melayani pembuatan software berbasis website maupun android by request sesuai kebutuhan dan keinginan kalian.",
      // list: "Melayani pembuatan software berbasis website maupun android by request sesuai kebutuhan dan keinginan kalian.",
    },
  ];
  return (
    <>
      <Container id="software" style={{ paddingTop: "4rem" }}>
        <Row className="software align-items-center justify-content-center">
          ...
          >
            ...
            <Col md={11} className="">
              <div className="text-center fw-bolder pb-2">
                PALUGADA - Apa yang lu mau Gue ada!
              </div>
              <div className="fs-6" style={{ color: "#9b9b9b" }}>
                  ...
                  <Col key={index}>
                    ...
                    >
                      <Row
                        ...
                        aria-expanded={open}
                        className="p-3 justify-content-start"
                      >
                        <Col
                          xs={3}
                          md={2}
                          className="align-self-center align-item-center"
                        >
                          <img
                            src={devcard.icon}
                            alt="Devimg"
                            className="logodev ms-3 me-3"
                          />
                        </Col>
                        <Col
                          xs={9}
                        ...
                        {/* <Col xs={12} className="pt-2 px-4">
                          <Card.Text>{devcard.list}</Card.Text>
                        </Col> */}
                      </Row>
                    </Card>
                  </Col>
