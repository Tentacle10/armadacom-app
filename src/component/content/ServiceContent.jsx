...
const ServiceContent = () => {
  const servicecard = [
    ...
    {
      icon: (
        <GearWideConnected size={45} style={{ color: "rgb(169 169 169)" }} />
      ),
      ...
      <Container id="service" style={{ paddingTop: "4rem" }}>
        <Row className="service">
          <Row className="appservice text-light">
            <Col
              className="d-flex flex-column justify-content-center align-items-center text-center d-block d-md-none pt-md-3"
              style={{ textShadow: "2px 2px 5px #555" }}
            >
              <div className="fw-bold fs-3">Fitur Tracking Service</div>
              <div className="fw-lighter fs-6 text-opacity-75">
            ...
            <Col
              ...
              style={{ textShadow: "2px 2px 5px #555" }}
            >
              <div className="fw-bold fs-3 d-none d-md-block">
                Fitur Tracking Service
              </div>
              <div className="fw-lighter text-opacity-75 d-none d-md-block">
                Memudahkan customer dalam memantau progres service
              </div>
              <div className="fw-bold fs-3 mt-md-4">Aplikasi Armadacom</div>
              <div className="fw-lighter text-opacity-75 fs-6">
                    ...
                    >
                      <Row className="p-3 justify-content-between">
                        <Col
                          xs={3}
                          md={2}
                          className="ps-4 align-self-center align-item-center"
                        >
                          {isiabout.icon}
                        </Col>
                        <Col
